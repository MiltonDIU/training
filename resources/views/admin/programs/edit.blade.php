...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($program->name) ? $program->name : 'Program' }}</h4>
            </div>
            ...
            <div class="btn-group btn-group-sm pull-right" role="group">
                ...
                <a href="{{ route('programs.program.create') }}" class="btn btn-primary" title="Create New Program">
        ...
        <div class="panel-body">
            ...
            {!! Form::model($program, [
                'method' => 'PUT',
                'route' => ['programs.program.update', $program->id],
