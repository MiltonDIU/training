...
@section('content')
            ...
            <div class="row">
                ...
                @foreach($upcoming as $allocation)
                    <div class="col-12 col-md-4">
                        <div class="card mb-4 shadow-sm h-75">
   ...
   {{-- <section id="program">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="display-5">Workshop &amp; Seminar</h1>
                </div>
                @foreach($programs as $program)
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm">
                            <img class="card-img-top"
                                 src="{{ asset('assets/uploads/program/banner/'.$program->banner) }}"
                                 alt="{{$program->name}}">
                            <div class="card-body">
                                <h5 class="card-title"><a
                                            href="{{ route('program.show', ['program'=>$program->programType->slug,'id'=>$program->id,'slug'=>$program->slug]) }}"
                                            title="{{$program->name}}">{{$program->name}}</a></h5>
                                ...
                                <p><i class="far fa-clock"></i> Total Hours: {{$program->total_hour}}</p>
                                <p><i class="fas fa-dollar-sign"></i> TK : {{($program->fees)?$program->fees:"Free"}}
                                </p>
...
<style>
    ...
    .shadow-sm{min-height:315px !important;}
    .card-body {
    min-height: 187px;}
</style>